...
Specifically, the complexity proof for the IDE algorithm requires the implementation of the micro-functions
...
To retrieve information about an input program, such as its control-flow supergraph or the set of receivers and their types, we used the WALA framework~\cite{fink2012wala}.
