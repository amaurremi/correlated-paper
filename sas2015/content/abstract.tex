\begin{abstract}
    ...
    will contain infeasible paths. Existing algorithms for data-flow analysis 
	...
	Environment} (IDE) problem, in which edge functions ``filter out'' data flow 
	along infeasible paths. A solution
