...
\begin{tikzpicture}
    ...
    \node [problem] (equiv) [above right=0.3cm and .7\dist of ifds.east] {Equivalent IDE problem};
    \node [problem] (ccide)[below=1.6cm of equiv.west, anchor=west] {Correlated-calls IDE problem};
    \node [result] (equivres) [right=\dist of equiv.east] {Equivalence-IDE result};
    \node [result] (ccres) [below=1.6cm of equivres.west,anchor=west] {Correlated-calls result};
    ...
    \path[->] (ifds) edge[out=40,in=179] node[above] {$\transEq$} (equiv);
