\begin{figure}
  ...
  \tikzstyle{problem}=[fill=greyblue,text width=1.6cm,rounded corners,font=\scriptsize,text=charcoal,drop shadow={ashadow, color=greyblue}]
...
\begin{tikzpicture}
    ...
    \path[->] (ccres) edge[out=0,in=230] node[above,font=\scriptsize] {$\backCC$} (improved);
