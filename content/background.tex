...
We will denote the source and end nodes of an edge $e$ as $\src e$ and $\target e$.
...
The four references take away space in the References section. Remove some of them?
}. 
...
Given a data-flow problem that satisfies the restrictions of IFDS, the algorithm provides a \textit{context-sensitive} \mtodo{Provide reference explaining context sensitivity?} solution in polynomial time.
