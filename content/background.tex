...
the \textit{meet-over-all-valid-paths} solution
  ...
  \mtodo{I like that the text is now very compact. But I wonder if some of the formulas should be put
  on a separate line and enumerated. For example, I need to reference the definition of $\textsf{MVP}_{\textsf{Env}}$ in the
  proof, but since it's embedded in the text, I'm repeating the formula in the appendix and reference the section. Is that fine?}
