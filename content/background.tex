...
the $n\to n'$ is an intraprocedural edge, a call-to-start edge, or an end-to-return edge.\mtodo{Do we leave the start-to-return edge out as a special case of intraprocedural edge?}
}
