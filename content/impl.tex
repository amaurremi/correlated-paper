...
\begin{example}
  ...
  \otodo{Can we combine the IDE Figure 7 with the IFDS Figure 4? It should be the same figure, just that Figure 7 has labels on the edges. We can initially tell the reader to ignore the labels until later.}
