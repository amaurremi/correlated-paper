...
The IFDS algorithm is an instance of the functional approach to data-flow analysis developed by M.\,Sharir and A.\,Pnueli~\cite{pnueli1981two}.
\commentout{
...
efficiency, and expressiveness. N.~Naeem and O.~Lhot\'ak~\cite{naeem2010pei} propose
...
Two other extensions target efficiency. E.\,Bodden et~al.~\cite{bodden2013spl} presents a framework
...
J.\,Rodriguez and O.\,Lhot\'ak evaluate a parallelized implementation of the IFDS algorithm using actors~\cite{rodriguez2010concurrent} that can take advantage of multiple processors.
...
M.~Sridharan et~al.'s improvements to the precision of pointer analysis
