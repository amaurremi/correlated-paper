...
\begin{proof}[\textbf{Proof of Lemma~\ref{lem:subsetifds}}]
  ...
  \begin{align*}
    ...
    &=\left(\lambda n'\,.\,\left\{d\,|\,\resultIDE(\transCC_R(P))(n')=(d,\,\ell),\,\forall r\,.\,\ell(r)\ne\top_T\right\}\right)(n)\\
    &=\left\{d\,|\,\resultIDE(\transCC_R(P))(n)=(d,\,\ell),\,\forall r\,.\,\ell(r)\ne\top_T\right\}\\
    &\subseteq\left\{d\,|\,\resultIDE(\transCC_R(P))(n)=(d,\,\ell),\,\ell\ne\topcc\right\}\\
...
\begin{proof}[\textbf{Proof of Lemma~\ref{lem:onlycorrrec}}]
  From Section~\ref{sec:ideToIfds} we know that
  \[
    \backCC(\resultIDE\left(\transCC_R(P)\right))
    =\lambda n.\{d\,|\,\resultIDE(\transCC_R(P))(n)=(d,\,\ell),\,\forall r\,.\,\ell(r)\ne\topcc\}\,.
  \]
  We can rewrite this equation as follows:
  \[
    \backCC(\resultIDE\left(\transCC_R(P)\right))
    =\lambda n.\{d\,|\,\forall r,\,\resultIDE(\transCC_R(P))(n)=(d,\,\ell),\,\forall r\,.\,\ell(r)\ne\topcc\}\,.
  \]
