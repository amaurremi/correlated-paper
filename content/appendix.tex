...
This appendix contains the proof for Lemma~\ref{} which shows that in a correlated-calls analysis, it is enough to consider only correlated-call receivers~$\rcc$.
