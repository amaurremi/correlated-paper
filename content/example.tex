...
to ``sinks'', which are typically securitive-sensitive
\mtodo{Should it be ``security-sensitive''?}
...
\mtodo{Maybe emphasize that more generally, the program is not
considered to leak secret information, and not mention the line numbers?}
